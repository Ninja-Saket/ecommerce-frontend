    ...
    <div className="container-fluid">
      <div className="row">
        ...
        {loading ? (<h4 className="text-danger">Loading....</h4>) : (<h4>Create Product</h4>)}
          <CreateProductForm handleChange={handleChange} handleSubmit={handleSubmit} handleCategoryChange={handleCategoryChange} values={values} subCategoryOptions={subCategoryOptions} showSubCategories={showSubCategories} setValues={setValues}/>
        </div>
      </div>
    </div>
  );
